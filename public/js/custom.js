...
/* ==========================================================================
   preview images and determine the length
   ========================================================================== */
   ...
   document.getElementById('images').addEventListener('change', function (e) {
    ...
    for (var i = 0; i < e.target.files.length; i++) {
        ...
        // Determine the dimension and update the 'dimension' input
        img.onload = function () {
            var dimensionInput = document.querySelector('[name="dimension"]');
            if (this.width > this.height) {
                dimensionInput.value = 'landscape';
            } else {
                dimensionInput.value = 'portrait';
            }
        };
    }
